...
export default function Dashboard() {
  return (
    <div className="w-screen-device h-screen-device bg-[#0d0d1a] p-[20px] overflow-hidden flex flex-col gap-card-gap">
      ...
      <div className="grid grid-cols-2 gap-card-gap min-h-0 flex-[2]">
      ...
      {/* Row 3 — Sensors (3-col) */}
      <div className="grid grid-cols-3 gap-card-gap min-h-0 flex-1">
      ...
      <div className="grid grid-cols-2 gap-card-gap min-h-0 flex-1">
